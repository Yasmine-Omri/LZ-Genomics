...
def retrain_and_test_for_label(
    ...
    with open(os.path.join("best_spas", f"{base_name}_label{label_idx}_class0.bin"), "wb") as f:
        f.write(b0)
    with open(os.path.join("best_spas", f"{base_name}_label{label_idx}_class1.bin"), "wb") as f:
        f.write(b1)
