...
OUTPUT_DIR="../outputs"
DATASET="../data/enhancer_annotation/enhancer_flanks.csv"
#DATASET="/Users/yasmineomri/Documents/EE376C/lz78_rust/repo/rebuttal_bench/BEND/scripts/enhancer_flanks.csv"
...
python ../python_scripts/enhancer_bin_flanks.py \
  ...
  --metric "auprc" \
  --max_depth "{12}" \
  > "$OUTPUT_DIR/enhancer_flanks.txt"
